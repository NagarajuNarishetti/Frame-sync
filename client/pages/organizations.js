              ...
              >
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-[0.7rem] font-bold uppercase border ${getRoleBadgeColor(org.role)} bg-white/70 !text-current`}>
                    <span className="mix-blend-multiply">{org.role}</span>
                  </span>
                </div>
                ...
                <button
                  ...
                  className="w-full px-5 py-2 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-700 transition-colors shadow"
                >
                ...
                <div className="space-y-4 md:col-span-2">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="mt-1">
                        <span className={`px-3 py-1 rounded-full text-[0.7rem] font-bold uppercase border ${getRoleBadgeColor(selectedOrg.role)} bg-white/70 !text-current`}>{selectedOrg.role}</span>
                      </div>
                    </div>
                    ...
                    {orgMembers.map((member) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <span className={`px-3 py-1 rounded-full text-[0.7rem] font-bold uppercase border ${getRoleBadgeColor(member.role)} bg-white/70 !text-current`}>{member.role}</span>
